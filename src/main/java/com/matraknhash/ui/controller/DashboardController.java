...
public class DashboardController {
    ...
    public void initialize() {
        ...
        lblSales.setText("Loading...");
        lblProfit.setText("Loading...");
        lblParts.setText("Loading...");
        lblLow.setText("Loading...");

        // Load stats in background thread to avoid freezing UI
        new Thread(() -> {
            try {
                ...
                e.printStackTrace();
                Platform.runLater(() -> {
                    lblSales.setText("Error");
                    lblProfit.setText("Error");
                    lblParts.setText("Error");
                    lblLow.setText("Error");
                });
            }
        }).start();
